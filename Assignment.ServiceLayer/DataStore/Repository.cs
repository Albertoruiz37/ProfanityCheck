...
namespace Assignment.ServiceLayer
{
    ...
    public class Repository
    {
        ...
        /// <returns></returns>
        public virtual int AddWord(Word word)
        {
            try
            {
        ...
        /// <returns></returns>
        public virtual int AddWords(List<Word> words)
        {
            try
            {
        ...
        /// <summary>
        /// Updates a determined word.
        /// </summary>
        /// <param name="word">Word to be updated</param>
        /// <returns></returns>
        public virtual int UpdateWord(Word word)
        {
            try
            {
                var updatedWord = context.Words.First(i => i.Id == word.Id);
                updatedWord.Value = word.Value;
                context.Words.Update(updatedWord);
                context.SaveChanges();
            }
            catch (DbUpdateException)
            {
        ...
        /// <returns></returns>
        public virtual int DeleteWord(Word word)
        {
            try
            {
                var deletedWord = context.Words.First(i => i.Id == word.Id);
                context.Words.Remove(deletedWord);
                context.SaveChanges();
            }
            catch (DbUpdateException)
            {
